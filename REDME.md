...
|----|------------|-------------|--------|----------|-------------|
|1|Bomba|Mini bomba de agua sumergible. Excelente para proyectos en los que se necesite de poco voltaje, de 2,5v a 6v DC, puede bombear caudales de hasta 80-120L/H a una altura de 40-110cm, dependiendo del voltaje de alimentación usado, a mayor volteja mayor caudal y altura de bombeo.|![image](https://user-images.githubusercontent.com/48172198/234114724-52ee77b0-f869-416e-87ed-5b68919f3814.png)|1|$55.00 MXN|
|2|Relay 8 Canales|Un relay de 8 canales es un dispositivo electrónico que permite controlar hasta 8 dispositivos electrónicos diferentes mediante una sola señal de control. Cada canal funciona como un interruptor independiente, ofreciendo una forma eficiente y fácil de controlar múltiples dispositivos. Con un diseño compacto y características adicionales como indicadores de encendido/apagado y protección contra sobretensión, un relay de 8 canales es un componente valioso para cualquier sistema de automatización y control.|![image](https://user-images.githubusercontent.com/41849043/215903727-05603d01-4f22-47cc-a362-7bcfad52bbb6.png)|1|$138.00 MXN|
...
|5|Sensor de Distancia Ultrasónica|Como su nombre lo indica, los sensores ultrasónicos miden la distancia mediante el uso de ondas ultrasónicas. El cabezal emite una onda ultrasónica y recibe la onda reflejada que retorna desde el objeto. Los sensores ultrasónicos miden la distancia al objeto contando el tiempo entre la emisión y la recepción.|![image](https://http2.mlstatic.com/D_NQ_NP_2X_912762-MLM53271445822_012023-F.webp)|1|$93.00 MXN|
